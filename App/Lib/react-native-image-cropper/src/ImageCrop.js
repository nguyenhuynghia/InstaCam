...
import { Image, PanResponder, PixelRatio, View } from 'react-native'
  ...
  render () {
    return (
      <View {...this._panResponder.panHandlers}>
        <Surface width={this.props.cropWidth} height={this.props.cropHeight} pixelRatio={this.props.pixelRatio}
                 ref="cropit">
          <GLImage
  ...
  crop () {
    ...
    if (captureConfig.format === 'file') {
      captureConfig.filePath =
        RNFS.CachesDirectoryPath + '/captured_image.png'
    }
    return this.refs.cropit.captureFrame(captureConfig)
  }
}
