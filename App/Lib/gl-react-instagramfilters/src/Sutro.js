...
const inputImageTexture2 = resolveAssetSource(require('../resources/vignetteMap.png'))
const inputImageTexture3 = resolveAssetSource(require('../resources/sutroMetal.png'))
const inputImageTexture4 = resolveAssetSource(require('../resources/softLight.png'))
const inputImageTexture5 = resolveAssetSource(require('../resources/sutroEdgeBurn.png'))
const inputImageTexture6 = resolveAssetSource(require('../resources/sutroCurves.png'))
